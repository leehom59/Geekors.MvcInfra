...
namespace ModelHelper.Helper
{
    public static class DataHelper
    {
        ...
        public static SelectList ToSelectList<TViewModel>(this IEnumerable<TViewModel> items, string displayField, string keyField = "Id")
            where TViewModel : class
        {
            return new SelectList(items.ToList(), keyField, displayField);
        }
